...
import itertools
from Pattern_set_based_SC import SandC
...
class MCTS:
    ...
    def monteCarloND(self):
        ...
        for Label in Labels:
            ...
            obj = SandC(Data=Without_duplicates, dataset=self.df, label=Label,
                        root=self.root, m_value=self.mValue,
                        minimum_covered=1)
            for i in obj.S_C_ND()[0]:
                print(i)
